...
> ⚠️ **Claude Desktop app ਦਾ "Upload local plugin" (drag-drop .zip) ਫੀਚਰ ਇਹਨਾਂ plugins ਨਾਲ ਕੰਮ ਨਹੀਂ ਕਰਦਾ** — schema mismatch ਕਾਰਨ। Desktop ਉਪਯੋਗਕਰਤਾ: ਹੇਠਾਂ ਦਿੱਤਾ Claude Code (CLI) ਰਾਹ ਵਰਤੋ, ਜਾਂ Anthropic propagation ਦੀ ਉਡੀਕ ਕਰੋ।

### Claude Code (CLI) — ਇੱਕਮਾਤਰ ਕੰਮ ਕਰਨ ਵਾਲਾ direct-install ਰਾਹ (CLI) — ਪੂਰੇ ਪਰਿਵਾਰ ਲਈ recommended
